...
- [x] создать scripts/smoke-test.sh
- [x] проверка всех установленных инструментов и их версий
- [x] запустить `make test` — все проверки должны пройти

### Task 11: Верификация
- [x] убедиться что образ собирается без ошибок
- [x] убедиться что все инструменты доступны в контейнере
- [x] проверить размер образа — должен быть разумным (<3GB)
- [x] запустить полный smoke-test

### Task 12: [Final] Документация
- [x] создать README.md с инструкциями по использованию
- [x] описать персистентный home и первую авторизацию
- [x] описать как маунтить проекты
- [x] добавить примеры использования с разными проектами
